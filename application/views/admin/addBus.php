				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Buses</div>
							</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
									<form enctype="multipart/form-data" method="post" action="<?=base_url('C_admin/addBus')?>" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												<label class="control-label col-md-3">Bus Name <span class="required"> * </span> </label>
												<div class="col-md-6">
													<input type="text" name="busname" placeholder="enter bus name" value="<?= set_value('busname') ?>" class="form-control input-height" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="text" name="busno" placeholder="enter bus number" value="<?= set_value('busno') ?>" class="form-control input-height" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="number" name="totalseats" placeholder="enter seats" value="<?= set_value('totalseats') ?>" class="form-control input-height" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="time" name="departureTime" value="<?= set_value('departureTime') ?>" class="form-control input-height" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="time" name="destinationTime" value="<?= set_value('destinationTime') ?>" class="form-control input-height" />
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6">
													<input type="number" name="fare" placeholder="enter fare" value="<?= set_value('fare') ?>" class="form-control input-height" />
												</div>
